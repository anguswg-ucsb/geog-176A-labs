...
## Odd cell values:
### Some of the cells have odd values of 1, 3, and 5. In the case of a value of 1, this means that only 1 method identified an area as flooded. A value of 3 indicates that 3 of the methods identified an area as flooded and a value of 5 means 5 of the 6 methods identified an area as flooded.
