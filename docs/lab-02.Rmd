...
gg_ca_roll_mean = ggplot(data = ca_rolling, aes(x = date, y = new_cases)) +
                                                # text = paste0('New cases: ', new_cases))) +
  geom_bar(aes(y = new_cases, text = paste0('New cases: ', new_cases)),
           col = 'cornflowerblue', fill = 'cyan4', stat = 'identity') +
...
gg_so_cal_roll_mean = ggplot(data = so_cal, aes(x = date, y = new_cases_per_cap)) +
                                                # text = paste0('Rolling mean per capita:', new_cases_per_cap))) +
  geom_bar(aes(y = new_cases_per_cap), col = 'cornflowerblue', fill = 'cyan4', stat = 'identity') +
  geom_line(aes(y = rolling_mean_per_cap),
                col = 'darkblue', size = 0.5) +
