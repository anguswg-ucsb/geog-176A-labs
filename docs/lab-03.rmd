...
The values I found match the values given by the ACLU for the border zone population, the percentage of the total US population, and the number of border zone cities.
