...
most_pop_cities_ggplot = ggplot() +
  ...
  labs(title = 'Ten most populated US cities',
       x = 'Longitude',
       y = 'Latitude')
pop_plot = plotly::ggplotly(most_pop_cities_ggplot)
pop_plot
```
...
dist_border_plot = plotly::ggplotly(distance_to_border_ggplot)
dist_border_plot
```
...
dist_plot = plotly::ggplotly(distance_to_states_ggplot)
dist_plot
```
...
equi_plot = plotly::ggplotly(equidist_ggplot)
equi_plot
```
...
border_plot = plotly::ggplotly(gg1)
border_plot
```
